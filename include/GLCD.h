...
////////////////////////////////////////////////////////////////////////////////
////                     glcd_160x80.h                        ////
//// La presente libreria gestiona la comunicaci�n con un GLCD de 160x80   ////
...
////                                                      ////
//// Para ver que pin del uC est� asociado a cada etiqueta,               ////
//// revisar la secci�n ETIQUETAS                                 ////
////                                                      ////
//// ---------------------------------------------------------------------   ////
//// PIN   NOMBRE   FUNCION                              ETIQUETA   ////
//// ---------------------------------------------------------------------   ////
////  1      VSS      Tierra GND                                    ////
////  2      VCC      voltaje positivo de alimentaci�n 5v                  ////
...
////  6      E      pasa una instrucci�n flanco descendente      GLCD_E      ////
////  7      DB0      -                                 GLCD_DB0   ////
////  8      DB1       |                                 GLCD_DB1   ////
////  9      DB2       |                                 GLCD_DB2   ////
////  10   DB3       |                                 GLCD_DB3   ////
...
////  13   DB6       |                                 GLCD_DB6   ////
////  14   DB7      -                                 GLCD_DB7   ////
////  15   CS      chip select, conexi�n = GND                        ////
////  16   RES      Reset, normalmente a 5v                         ////
////  17   VLCD   contraste, P1 = 10k (ver esquema abajo)               ////
////  18   DISPOFF   GLCD apagado cuando est� a GND, normalmente a 5v      ////
////  19   EL1      backligh   sin conexi�n                        ////
////  20   EL1      backlight   sin conexi�n                        ////
////                                                      ////
...
////                                                      ////
//// glcd_init(mode)                                          ////
////    * Debe ser llamada antes de cualquier otra funci�n, inicializa el   ////
////     GLCD en modo gr�fico o modo alfanum�rico.                     ////
////     - mode: CHARACTER - modo alfanum�rico, GRAPHIC - modo gr�fico      ////
////     NOTA: Para configurar el cursor en modo alfanum�rico, ir a la    ////
////         secci�n CONFIGURACION INICIAL DEL GLCD, y descomentar      ////
...
////     - color: color de la l�nea, ON = negra, OFF = blanca            ////
////                                                      ////
//// glcd_rect(x1,y1,x2,y2,fill,color)                              ////
////   * Dibuja un rect�ngulo en el GLCD o en el buffer, dado por las       ////
////     coordenadas x1,y1 y x2,y2, puede ser con relleno o             ////
////     solamente el per�metro.                                 ////
////     - x1,y1: coordenadas superior izquierda del rect�ngulo         ////
////     - x2,y2: coordenadas inferor derecha del rect�ngulo            ////
////     - fill: YES - con relleno, NO - solo per�metro               ////
////     - color: color del per�metro y/o del relleno, ON / OFF         ////
////                                                      ////
...
////                                                      ////
//// glcd_putc(data)                                          ////
////   * Funci�n para imprimir caracteres en el GLCD en modo alfanum�rico,   ////
////     su uso es igual al de lcd_putc() de los LCD alfanum�ricos.      ////
////     - data: un solo caracter o una cadena de caracteres            ////
////           las siguientes son secuencias de escape:               ////
////           \n - salta al inicio de la siguiente l�nea            ////
////           \f - borra la pantalla en modo de alfan�merico y se      ////
////               posiciona en la esquina superior izquierda         ////
////   * ejemplo:                                             ////
////   glcd_putc("HOLA MUNDO\n");   // imprime "HOLA MUNDO" y salta l�nea   ////
...
////   // "la temperatura es: 25", y salta de l�nea.                  ////
////                                                      ////
//// glcd_gotoxy(x,y)                                          ////
////   * Salta a las coordenadas x,y del GLCD en modo alfanum�rico         ////
...
//// Fecha de liberaci�n: 19/07/2012, M�xico, EdoMex                  ////
//// Versi�n de CCS: 4.104                                       ////
//// Versi�n de la libreria glcd_160x80.h: 1.00                        ////
...
//// siempre y cuando no se utilice con prop�sitos comerciales, se puede   ////
...
//// * El modo de lectura del GLCD al uC, no se puede leer informaci�n      ////
////   proveniente del GLCD                                       ////
//// * El bit busy_flag no se encuentra habilitado para ser le�do, en su   ////
////   lugar, se implementa un tiempo de espera despu�s de escribir un      ////
////   comando, pudiendo el usuario variar el mismo.                  ////
//// * La secuencia de escape \b en modo alfanum�rico que permite retroce-   ////
////   der una posici�n de memoria el cursor.                        ////
//// * Se advierte que algunas funciones en modo gr�fico pudieran llegar a    ////
...
////   im�genes m�s peque�as en diferentes posiciones de pantalla.         ////
//// * No se ha escrito una funci�n para leer multiples im�genes declaradas ////
////   en arreglos tipo const, en su lugar escribo la siguiente funci�n      ////
////   en el programa principal:                                 ////
////                                                      ////
//// void put_image()                                          ////////////
//// {                                                            ////
////   glcd_go_address(0);      // manda la posici�n de memoria 0 del GLCD CGRAM   ////
...
////                                                            ////
//// Al llamar esta funci�n, la misma escribir� en la pantalla del GCLD la imagen   ////
...
/* NOTA IMPORTANTE!: El configurar los pines de forma separada tiene la ventaja
                de la flexibilidad de conexi�n, pero tambi�n tiene la gran
                desventaja que el tiempo de procesamiento se eleva, en
                comparaci�n de la velocidad necesaria en el GLCD, as� que
...
// con lo que todos los comandos de impresi�n que se le manden al GLCD no se ver�n
// en la pantalla, sino que se escribir�n en el buffer interno, esto ahorra mucho
// tiempo de ejecuci�n, ya que una vez que el buffer contiene todo lo que se desea
// mostrar en la pantalla, se manda al GLCD por medio del comando glcd_load_buffer(),
// lo cu�l se traduce en una elevada velocidad de impresi�n.

/*    NOTA IMPORTANTE: El uso del buffer interno solo est� disponible a partir de los
                ...
                de 1600 bytes. Si se est� utilizando un PIC16F, se deber� 
                comentar esta l�nea y no usar buffer. */
...
// ETIQUETAS
//
// Cambia los pines de conexi�n como m�s te convenga
...
dependiendo de la configuraci�n que requieras.
...
#ifndef GLCD_WIDTH
#define GLCD_WIDTH 160       // tama�o en pixeles del ancho
#define GLCD_HEIGHT 80       // tama�o en pixeles de la altura
#endif
